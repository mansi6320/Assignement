...
<form method="post" action="AddStudent.php">
  ...
  <br>
               ...
               <br> <label>First Name</label>
                ...
                <br><label>Medical Info</label>
    			<input type="text" name="MedicalINF"><br> 
...
if (isset($_POST['SubjectId'])) {
  ...
  $Class = $_POST['Class'];
  $MedicalINF = $_POST['MedicalINF'];

  // Establishing database connection
  $link = mysqli_connect("localhost", "root", "", "student89-3530313543fa");

  // Using prepared statements to prevent SQL injection attacks
  $stmt = mysqli_prepare($link, "INSERT INTO `students` (`SubjectId`, `FirstName`, `LastName`, `Class`, `MedicalINF`) VALUES (?, ?, ?, ?, ?)");
  mysqli_stmt_bind_param($stmt, "sssss", $_POST['SubjectId'], $FirstName, $LastName, $Class, $MedicalINF);
