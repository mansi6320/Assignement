...
<form method="post" action="AddClass.php">
	...
	<br><label>Class Name</label>
	<input type="text" name="ClassName"><br>

	<br><label>Select Teacher </label>
	<select name="TeacherID">
		<?php
		$sql = mysqli_query($link, "SELECT TeacherId, FirstName FROM teacher");
...
if (isset($_POST['submit'])) {
  ...
  $stmt = mysqli_prepare($link, "INSERT INTO classes (ClassName, TeacherId, Capacity) VALUES (?, ?, ?)");
  mysqli_stmt_bind_param($stmt, "ssi", $_POST['ClassName'], $_POST['TeacherID'], $_POST['Capacity']);
