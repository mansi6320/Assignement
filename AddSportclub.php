...
<form method="post" action="AddSportclub.php">
	...
	<br>
               ...
               <br> <label>First Name</label>
                ...
                <br><label>Sport Name</label>
    			<input type="text" name="SportName"><br> 
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `sportsclub` (PupilID, `FirstName`, `LastName`, `SportName`, `Age`) VALUES ('$PupilID', '$FirstName', '$LastName', '$SportName', '$Age')";
