...
if (isset($_POST['submit'])) {
  ...
  $stmt = mysqli_prepare($link, "INSERT INTO `teacher` (`PupilID`, `FirstName`, `LastName`, `PhNumber`, `Email`, `Address`) VALUES (?, ?, ?, ?, ?, ?)");
  mysqli_stmt_bind_param($stmt, "ssisss", $PupilID, $FirstName, $LastName, $PhNumber, $Email, $Address);
